...
#figure(image("lennard_jones.png", width: 80%),
...
На @frame0 --- @frame2 представлены несколько кадров из созданной анимации смоделированного процесса релаксации многоатомной системы.

#figure(image("anim0.png", height: 80%),
    caption: [Начальное положение атомов в процессе релаксации]) <frame0>

#figure(image("anim1.png"),
    caption: [Положение атомов в середине моделирования процесса релаксации]) <frame1>

#figure(image("anim2.png"),
    caption: [Конечное положение атомов в процессе релаксации]) <frame2>
